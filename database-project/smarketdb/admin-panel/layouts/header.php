...
define("ADMINURL", "http://localhost/database-project/smarketdb/admin-panel");
    ...
    <nav class="navbar header-top fixed-top navbar-expand-lg  navbar-dark bg-dark">
      ...
      <?php if(isset($_SESSION['adminname'])) : ?>
        <ul class="navbar-nav side-nav" >
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo ADMINURL; ?>/employees-admins\show-employees.php" style="margin-left: 20px;">Employees</a>
          </li>
          <li class="nav-item">
