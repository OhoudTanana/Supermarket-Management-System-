...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2024 at 11:22 PM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `CountOrders` ()   BEGIN
    SELECT COUNT(*) AS totalOrders FROM orders;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `CountProductTypes` ()   BEGIN
    DECLARE done INT DEFAULT FALSE;
    DECLARE productType VARCHAR(50);
    
    -- Declare a cursor to select distinct product types
    DECLARE cur CURSOR FOR SELECT DISTINCT productType FROM products;
    DECLARE CONTINUE HANDLER FOR NOT FOUND SET done = TRUE;

    -- Create a temporary table to store the count
    CREATE TEMPORARY TABLE IF NOT EXISTS temp_count (productType VARCHAR(50), typeCount INT);

    -- Open the cursor
    OPEN cur;

    -- Loop through the cursor and count product types
    read_loop: LOOP
        FETCH cur INTO productType;

        IF done THEN
            LEAVE read_loop;
        END IF;

        -- Count occurrences of each product type and insert into the temporary table
        INSERT INTO temp_count (productType, typeCount)
        SELECT productType, COUNT(*) FROM products WHERE productType = productType;
    END LOOP;
...
-- Functions
--
CREATE DEFINER=`root`@`localhost` FUNCTION `GetEmployeeCount` () RETURNS INT(11)  BEGIN
    DECLARE count INT;
...
(1, 'admin.first@gmail.com', 'admin.first@gmail.com', '$2y$10$9ieQ8zT5ud71GVVEr0RDEO1h3mcy4M6sHH3Fc7ip5vkhI3L.Wn216', '2024-01-02 06:54:59'),
(2, 'admin.second@gmail.com', 'admin.second@gmail.com', '$2y$10$DQ2.OQWdYmm1Lu.vWAUN..l0GRfMoo1GmMNDUwmSCQj/lORHWdl9u', '2024-01-02 12:33:39'),
(3, 'third', 'admin.third@gmail.com', '$2y$10$cWJiMUbswzEGpHAbnFc0VeZ9INEcfdLUqoSercuCcxYP73pxAPMD.', '2024-01-03 02:03:15'),
(4, 'marlen@gmail.com', 'marlen@gmail.com', 'marlen@gmail.com', '2024-01-07 11:32:33'),
(5, 'marlenmrad@gmail.com', 'marlenmrad@gmail.com', '$2y$10$Vv6wr4iOhoIqsFHDe9Ct1eViBr4TmUeLPBlkbPzhGAFobNhA83eNu', '2024-01-12 03:07:49');
...
(10426, 'S10_1678', 3, 48.81, 23),
(10426, 'S12_1666', 1, 77.90, 25),
(10427, 'S10_1949', 1, 98.58, 26),
(10428, 'S10_1678', 3, 48.81, 4),
(10428, 'S12_3148', 2, 89.14, 6),
(10429, 'S10_1678', 3, 48.81, 7),
(10429, 'S10_4698', 1, 91.02, 9),
(10430, 'S10_1678', 1, 48.81, 10);
...
(10426, '2024-01-11', '2024-01-18', NULL, 'Pending', '', 103),
(10427, '2024-01-11', '2024-01-18', NULL, 'Pending', '', 103),
(10428, '2024-01-11', '2024-01-18', NULL, 'Pending', '', 141),
(10429, '2024-01-11', '2024-01-18', NULL, 'Pending', '', 103),
(10430, '2024-01-11', '2024-01-18', NULL, 'Pending', '', 103);
...
(103, 'CHECK65a0067e484bd', '2024-01-11', 224.33),
(103, 'CHECK65a0077535e7a', '2024-01-11', 98.58),
(103, 'CHECK65a016ff188f1', '2024-01-11', 237.45),
(103, 'CHECK65a018d0b22bb', '2024-01-11', 48.81),
...
(141, 'CHECK65a016a3cc23c', '2024-01-11', 324.71),
...
ALTER TABLE `employees`
  ...
  ADD KEY `idx_employeeNumber` (`employeeNumber`);
...
ALTER TABLE `orders`
  ...
  ADD KEY `idx_status_shippedDate` (`status`,`shippedDate`);
...
--
ALTER TABLE `orderdetails`
  MODIFY `orderNumber` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10431;
...
--
ALTER TABLE `shopping_cart`
  ADD CONSTRAINT `shopping_cart_ibfk_1` FOREIGN KEY (`customerNumber`) REFERENCES `customers` (`customerNumber`),
  ADD CONSTRAINT `shopping_cart_ibfk_2` FOREIGN KEY (`productCode`) REFERENCES `products` (`productCode`);
COMMIT;
